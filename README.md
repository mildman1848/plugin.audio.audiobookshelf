...
Kodi-Addon fuer Audiobookshelf mit Login, Wiedergabe, Fortschritts-Sync und STRM-Export fuer Hoerbuecher und Podcasts.
...
- `.github/workflows/release-publish.yml`: veroeffentlicht nach einem GitHub-Release automatisch in die Kodi-Repo

## Repository-Hygiene

Das Repo enthaelt dieselbe Grundausstattung wie die anderen eigenstaendigen Addon-Repos:
